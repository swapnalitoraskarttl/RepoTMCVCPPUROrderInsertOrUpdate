 ...
 * 2020-02-29T13:43:35.591+05:30
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "Siebel_spcOrder",
                  wsdlLocation = "file:/D:/GithubProject/prjTMCVCPPUROrderInsertOrUpdate/prjTMCVCPPUROrderInsertOrUpdate/src/main/resources/CPPUROrder.wsdl",
...
public class SiebelSpcOrder extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/GithubProject/prjTMCVCPPUROrderInsertOrUpdate/prjTMCVCPPUROrderInsertOrUpdate/src/main/resources/CPPUROrder.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SiebelSpcOrder.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/GithubProject/prjTMCVCPPUROrderInsertOrUpdate/prjTMCVCPPUROrderInsertOrUpdate/src/main/resources/CPPUROrder.wsdl");
        }
        WSDL_LOCATION = url;
    }
